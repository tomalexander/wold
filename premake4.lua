...
link_library_deps();
includedirs {"topaz/src", "new_noise/src"}
files({"topaz/src/libmain.cpp", "topaz/src/egg_parser.cpp", "topaz/src/util.cpp", "topaz/src/model.cpp", "topaz/src/quaternion.cpp", "topaz/src/sqt.cpp", "topaz/src/panda_node.cpp", "topaz/src/shaders.cpp", "topaz/src/camera.cpp", "topaz/src/free_view_camera.cpp", "topaz/src/light.cpp", "topaz/src/nolight.cpp", "topaz/src/lookat_camera.cpp", "topaz/src/uberlight.cpp", "topaz/src/floor_model.cpp", "topaz/src/unit.cpp", "topaz/src/joint.cpp", "topaz/src/animation.cpp", "topaz/src/vertex.cpp", "topaz/src/gl_program.cpp", "topaz/src/rigidbody.cpp", "topaz/src/gameobject.cpp", "topaz/src/collider.cpp", "topaz/src/sphere_collider.cpp", "topaz/src/sphere_primitive.cpp", "topaz/src/collision.cpp", "topaz/src/aabb_collider.cpp", "topaz/src/box_primitive.cpp", "src/main.cpp", "topaz/src/overlay.cpp", "topaz/src/terrain.cpp", "topaz/src/quaternion.cpp", "topaz/src/matrix.cpp", "topaz/src/vector.cpp", "src/world.cpp", "src/agent.cpp"})
